...
<html lang="en">
    ...
    <body class=" login">
        ...
        <!-- BEGIN LOGIN -->
        <div class="content">
        <form class="#" action="{{route('pwd.reset')}}" method="post">
            @csrf
                <h4 class="font-green">Reinitialiser mot de passe</h4>
                <div class="form-group">
               
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9"></label>
                    <input class="form-control placeholder-no-fix" type="password" autocomplete="off" id="" placeholder="Nouveau mot de passe" name="password" /> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Retapez votre mot de passe</label>
                ...
                <div class="form-actions">
                    <a href="/"><button type="button" id="back-btn" class="btn green btn-outline">Login</i></button></a>
