...
<div class="col-md-8 col-sm-8" style="height:100% ">
        <div class="portlet light bordered" style="height: 100%; overflow: 0;">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a class="btn-icon-only btn-default" href="{{route('user.pivot',['type'=>1])}}">
    ...
    <div class="col-md-4 col-sm-4" style="height:100% ">
        <div class="portlet light bordered" style="height: 100%; overflow: 0;">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a class="btn-icon-only btn-default" href="{{route('user.pivot',['type'=>0])}}">
                    Tableau croisé dynamique <i class="fa fa-random"></i>
                    </a>
                </div>
            </div>
...
<div class="col-md-6 col-sm-6" style="height:100% ">
        <div class="portlet light bordered" style="height: 100%; overflow: auto;">
            <div class="portlet-title">
                ...
                <div class="actions">
                <a class=" btn-icon-only btn-default" href="{{route('user.pivot',['type'=>5])}}">
                Tableau croisé dynamique <i class="fa fa-random"></i>
                    </a>
                </div>
            </div>
    ...
    <div class="col-md-6 col-sm-6" style="height:100% ">
        <div class="portlet light bordered" style="height: 100%; overflow: auto;">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a class="btn-icon-only btn-default" href="{{route('user.pivot',['type'=>4])}}">
                    Tableau croisé dynamique <i class="fa fa-random"></i>
                    </a>
                </div>
            </div>
