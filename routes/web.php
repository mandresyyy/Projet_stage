...
Route::get('/admin/deconnecte',[UtilisateurContr::class,"log_out"])->name('admin.log_out');
...
Route::POST('/admin/mise_a_jour_profile',[UtilisateurContr::class,"update_profile"])->name('admin.profil.update');
Route::POST('/admin/mise_a_jour/mot_de_passe',[UtilisateurContr::class,"change_password"])->name('admin.mdp.update');
